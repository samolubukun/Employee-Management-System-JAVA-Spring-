...
public class AdminStaffController {
    ...
    @GetMapping("/admin-form-per-dept/{id}")
    public String addAdminPerDept(@PathVariable("id") Long did, ModelMap perDeptAdminModel) {

        Department department = departmentService.getDepartment(did);

        perDeptAdminModel.addAttribute("deptper", department);

        return "adminformperdept";
    }
